...
CREATE TABLE IF NOT EXISTS `operation_logs` (
  ...
  KEY `idx_oplog_module_created` (`module`, `created_at`),
  KEY `idx_oplog_module_action` (`module`, `action`),
  KEY `idx_oplog_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- sync_jobs / sync_logs / shop_sync_status：完整 DDL 由 migrateSyncStability41 维护（勿在此保留旧版 sync_jobs）
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  KEY `idx_orders_dash_tenant_paid` (`tenant_id`, `paid_at`, `market`, `shop_id`),
  KEY `idx_orders_dash_tenant_created` (`tenant_id`, `created_at_platform`, `market`, `shop_id`),
  KEY `idx_orders_dash_tenant_status` (`tenant_id`, `order_status`, `created_at_platform`),
  KEY `idx_orders_dash_tenant_astatus_paid` (`tenant_id`, `analytics_status`, `paid_at`),
  KEY `idx_orders_dash_tenant_astatus_created` (`tenant_id`, `analytics_status`, `created_at_platform`),
  KEY `idx_orders_dash_tenant_shop_astatus_paid` (`tenant_id`, `shop_id`, `analytics_status`, `paid_at`),
  KEY `idx_orders_dash_tenant_market_astatus_paid` (`tenant_id`, `market`, `analytics_status`, `paid_at`),
  KEY `idx_orders_dash_tenant_shop_status_paid` (`tenant_id`, `shop_id`, `order_status`, `paid_at`),
  KEY `idx_orders_dash_tenant_market_status_paid` (`tenant_id`, `market`, `order_status`, `paid_at`),
  KEY `idx_orders_dash_tenant_shop_astatus_created` (`tenant_id`, `shop_id`, `analytics_status`, `created_at_platform`),
  KEY `idx_orders_dash_tenant_market_astatus_created` (`tenant_id`, `market`, `analytics_status`, `created_at_platform`),
  KEY `idx_orders_dash_tenant_astatus_updated` (`tenant_id`, `analytics_status`, `updated_at`),
...
CREATE TABLE IF NOT EXISTS `order_items` (
  ...
  KEY `idx_order_items_tenant_platform_order` (`tenant_id`, `platform`, `platform_order_id`),
  KEY `idx_order_items_tenant_order_id` (`tenant_id`, `order_id`),
...
-- Dashboard 本地汇总层（Phase-1 staging；API 优先读 table cache，miss 时 fallback MySQL）
